...
#ifndef __OF1X_PIPELINE_GENERIC_PP_H__
#define __OF1X_PIPELINE_GENERIC_PP_H__
...
*
*/
static inline void __of1x_process_packet_pipeline_generic(const unsigned int tid, const of_switch_t *sw, datapacket_t *const pkt){
...
* @ingroup core_pp 
*/
static inline void __of1x_process_packet_out_pipeline_generic(const unsigned int tid, const of1x_switch_t *sw, datapacket_t *const pkt, const of1x_action_group_t* apply_actions_group){
	...
	if(reinject_pkt)
		__of1x_process_packet_pipeline_generic(ROFL_PIPELINE_LOCKED_TID, (const of_switch_t*)sw, reinject_pkt);
